...
def save_to_csv(category_name, names, links,job_link):
    ...
    filename = f"C:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/コンサルティング・リサーチ業界・専門事務所・監査法人・税理士法{category_name}.csv"
...
# category_name = "コンサルティング・リサーチ業界・専門事務所・監査法人・税理士法人"
# category_code = "09L"
...
csv_files = glob.glob(os.path.join("c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/コンサルティング・リサーチ業界・専門事務所・監査法人・税理士法", '*.csv'))
...
for file_path in csv_files:
  ...
  for i, company_url in enumerate(tqdm(target_df.values.tolist(), desc="Processing companies")):
      ...
      if (i + 1) % 1000 == 0:
          save_temp_csv(company_info_data, "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/コンサルティング・リサーチ業界・専門事務所・監査法人・税理士法", i + 1)
          company_info_data = []
      time.sleep(1.1)
