...
import datetime   # for windows task scheduler


fileAuto = open(r'C:\Users\user\Desktop\cograph_project\cograph-database-pj\backend\Web_scrapping\医薬品・医療機器・ライフサイエンス・医療系サービス.txt', 'a')
fileAuto.write(f'{datetime.datetime.now} - The script ran \n')
...
def save_to_csv(category_name, names, links,job_link):
    ...
    filename = f"C:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/医薬品・医療機器・ライフサイエンス・医療系サービス.csv"
...
# category_name = "医薬品・医療機器・ライフサイエンス・医療系サービス"
# category_code = "06L"
# scrape_company_info(category_name, category_code, num_pages)



# csv_files = glob.glob(os.path.join("c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/医薬品・医療機器・ライフサイエンス・医療系サービス", '*.csv'))
...
#       if (i + 1) % 1000 == 0:
#           save_temp_csv(company_info_data, "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/医薬品・医療機器・ライフサイエンス・医療系サービス", i + 1)
#           company_info_data = []
#       time.sleep(1.1)
...
csv_files = glob.glob(os.path.join(
    "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/医薬品・医療機器・ライフサイエンス・医療系サービス", '*.csv'
))
print(f'csv_files ~ {csv_files}')
        ...
        try:
            ...
            if (i + 1) % 1000 == 0:
                try:
                    save_temp_csv(
                        company_info_data, 
                        "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/医薬品・医療機器・ライフサイエンス・医療系サービス", 
                        i + 1
                    )
                    company_info_data = []
                except Exception as e:
