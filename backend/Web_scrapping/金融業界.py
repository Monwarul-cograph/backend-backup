...
fileAuto = open(r'C:\Users\user\Desktop\cograph_project\cograph-database-pj\backend\Web_scrapping\外食産業・飲食業界.txt', 'a')
...
def save_to_csv(category_name, names, links,job_link):
    ...
    filename = f"C:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/金融業界{category_name}.csv"
...
csv_files = glob.glob(os.path.join(
    "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/金融業界", '*.csv'
))
        ...
        try:
            ...
            if (i + 1) % 1000 == 0:
                try:
                    save_temp_csv(
                        company_info_data, 
                        "c:/Users/user/Desktop/cograph_project/cograph-database-pj/backend/data/金融業界", 
                        i + 1
                    )
                    company_info_data = []
                except Exception as e:
